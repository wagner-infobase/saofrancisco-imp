...
@Entity
@Table(name="ARQCONF_MES_CORRENTE")
public class FileConfMonthCurrent implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ARQCONF_MES_CORRENTE_ID_GENERATOR", sequenceName="SQ_ARQCONF_MES_CORRENTE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ARQCONF_MES_CORRENTE_ID_GENERATOR")
	@Column(name="COD_ARQCONF_MES_CORRENTE")
	private Long id;
